 ...
 *
 */
public class SdcbenchResNetDriver extends AbstractJobDriver{
	/**
	 * Singleton code block
	 */
	private static SdcbenchResNetDriver driver=null;	
	public SdcbenchResNetDriver(){initVariables();}
	public synchronized static SdcbenchResNetDriver getInstance() {
		if (driver == null) {
			driver = new SdcbenchResNetDriver();
		}
		return driver;
	}
