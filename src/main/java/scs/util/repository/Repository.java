...
import scs.util.loadGen.driver.sdcbench.SdcbenchResNetDriver;
...
public class Repository{ 
	...
	public static String tpcwBaseURL="";
	public static String tpcwParmStr="";
	...
	private static void readProperties(){
		...
		Repository.tpcwBaseURL=prop.getProperty("tpcwBaseURL").trim();
		Repository.tpcwParmStr=prop.getProperty("tpcwParmStr").trim();
	...
	private static LoaderDriver loaderMapping(int loaderIndex){
		...
		if(loaderIndex==22){
			return new LoaderDriver("sdcBenchResNet", SdcbenchResNetDriver.getInstance());
		}
		if(loaderIndex==23){
